// services/egress-gate/src/switch.store.ts
// Reads and writes the switch states. Kept in Postgres rather than in memory so a
// restart of the gate does not silently repair the demo while a visitor is watching.
