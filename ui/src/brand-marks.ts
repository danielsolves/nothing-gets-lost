...
// The actual outlines of the four third-party marks, drawn in one colour.
//
// Not the full-colour logos. Slack's mark is four colours and Stripe's, HubSpot's and
// PayPal's are their own, and dropping four foreign palettes into a page with one
// accent would fight everything else on it. What is worth having is the *shape*: the
// Stripe S, the HubSpot sprocket, the Slack hash, the PayPal P are recognised long
// before the label is read. So the published outlines are used, filled with the
// tile's own tint.
//
...
//   PayPal           simple-icons (CC0-1.0), 24x24 viewBox
